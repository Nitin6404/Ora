...
export default function AddPatient() {
  ...
  const tabs = ["Patient Details", "Assign Program", "QR Code"];
      ...
      <div className="flex flex-col min-h-screen font-inter">
        <div className="sticky top-0 z-[999] p-4 md:px-6 md:py-3 backdrop-blur-sm md:ml-4">
          <div className="p-8 flex flex-col gap-6">
            <h2 className="text-2xl font-semibold">New Programs</h2>
            <div className="flex gap-2 overflow-x-auto no-scrollbar w-full md:w-auto rounded-full px-2 py-1 bg-white backdrop-blur-md border border-white/30 shadow-sm">
              {tabs.map((tab) => (
                <button
                  key={tab}
