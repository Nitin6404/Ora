...
const SessionPerformanceChart = () => {
  ...
  const sessionCompleted = 8;
  const distressRaised = 5;
  ...
  <Cell fill="#e5e7eb" />
        ...
        <div className="grid grid-rows-3 gap-4 mt-2 lg:mt-4">
          <div className="text-start flex justify-between items-center space-x-5">
            ...
            <div className="text-sm text-gray-600">Total <br /> Sessions</div>
            <div className="text-2xl font-bold ">24</div>
          </div>
          <div className="text-start flex justify-between items-center space-x-5">
            <div className="w-2 h-full bg-[#69e8a7] rounded-md" />
            <div className="text-sm text-gray-600">Session <br />  Completed</div>
            <div className="text-2xl font-bold ">08</div>
          </div>
          <div className="text-start flex justify-between items-center space-x-5">
            <div className="w-2 h-full bg-[#faa499] rounded-md" />
            <div className="text-sm text-gray-600">Distress Flags <br /> Raised</div>
