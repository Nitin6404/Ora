...
const ProgramForm = ({
    ...
    const dropdownFields = [
        ...
        },
        {
            ...
            getSelected: (value) => TARGET_GROUP_OPTIONS.find(opt => opt.value === value)?.name,
    ...
    return (
        <div className="bg-white/30 mx-2 lg:px-8 lg:py-4 rounded-xl h-[92%] flex flex-col justify-between">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 p-2">
                ...
                <div className="lg:space-y-4 space-y-2">
                    {dropdownFields.map(({ label, options, valueKey, getSelected, getValue }) => (
                        <div className="flex flex-col" key={valueKey}>
                            <CustomDropdown
                                label={label}
                                options={options}
                                selected={getSelected ? getSelected(formData[valueKey]) : formData[valueKey]}
                                onSelect={(item) =>
                                    setFormData(prev => ({
                                        ...prev,
