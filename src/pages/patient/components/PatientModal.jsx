...
const PatientInfoCard = ({ data, onClose }) => {
  return (
    <div className="flex flex-col gap-4 overflow-auto">
      ...
      <div className="bg-white rounded-xl font-medium text-gray-500 overflow-auto no-scrollbar h-full">
        <div className="overflow-hidden no-scrollbar p-6 space-y-4 rounded-xl">
...
const ProgramCard = ({ program, index }) => (
  ...
  >
    ...
    <div className="space-y-2 mt-3 font-medium text-black">
      ...
      <div className="flex justify-between items-center">
        <span className="text-gray-600 font-medium">Mood Trend</span>
        <div className="flex items-center px-[0.75em] py-[0.25em] rounded-full bg-pink-50">
          {program?.mood_trend ? (
            <>
              {program?.mood_trend !== null && (
                <MoodEmoji mood={program?.mood_trend} />
              )}
              <span className="mx-[0.5em] font-medium">
                {program?.mood_trend !== null
                  ? snakeToCamel(program?.mood_trend)
                  : "-"}
              </span>
            </>
          ) : (
      ...
      <div className="space-y-[0.75em] mt-[0.5em]">
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center px-[0.75em] py-[0.25em] rounded-full bg-pink-50">
            {session?.mood ? (
              <>
                <MoodEmoji mood={session?.mood} />
                <span className="mx-[0.5em] font-medium">
                  {snakeToCamel(session?.mood) || "-"}
                </span>
              </>
            ) : (
              "-"
