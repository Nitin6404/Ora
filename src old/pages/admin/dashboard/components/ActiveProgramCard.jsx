const ActiveProgramsCard = () => {
  return (
    <div className="rounded-3xl p-6 text-white relative overflow-visible w-full h-full border-t-2 border-b-2 border-t-white border-b-white "
    // style={{
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <div className="text-[60px] text-[#7267ec] font-bold">16</div>
      </div>
