...
const CustomFileUploader = ({ onFileSelect, initialImage, onFileRemove }) => {
  ...
  return (
    <div className="bg-[#f1f0fd] max-w-md mx-auto px-6 py-4 border border-gray-300 rounded-2xl mt-1 lg:mt-2">
      ...
      >
        ...
        <button disabled={uploading || uploaded} className="mt-2 font-medium border border-[#7367F0] text-xs text-[#7367F0] px-3 py-1.5 rounded-lg disabled:cursor-not-allowed">
          Browse Files
        </button>
        <input
          type="file"
