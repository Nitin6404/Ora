              ...
              <div className="bg-white/30 mx-2 md:mx-4 lg:px-8 lg:py-4 !rounded-[15px] lg:rounded-[16px] mt-6">
                <div className="w-full h-[400px] max-h-[500px] overflow-y-auto relative bg-white/30">
                  ...
                  <button
                    ...
                    className="login-button !w-48 sm:!w-40 fixed sm:absolute top-16 right-4 z-50 !px-3 !py-2 flex items-center gap-2"
                  >
                  ...
                  <button
                    ...
                    className="m-2 px-4 py-2 bg-green-500 absolute top-2 left-2 z-50 flex items-center gap-2 text-white rounded"
                  >
                    Add Music/Video
                  </button>
