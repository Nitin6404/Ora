...
export default function EditProgram() {
    ...
    const handleSubmit = async (isSaveAsDraft = false) => {
        ...
        try {
            ...
            if (isSaveAsDraft) {
                ...
                const res = await axios.post(API_BASE_URL + ENDPOINTS.program, multipartData, {
                    headers: {
                ...
                navigate("/programs/edit-decision-tree-flow", { state: { programDetails: dataToSend } });
            }
        } catch (err) {
    ...
    const fetchProgramDetails = async () => {
        ...
        try {
            const res = await axios.get(`${API_BASE_URL}${ENDPOINTS.program}/${id}`, {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            })
