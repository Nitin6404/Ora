    ...
    const handleSubmit = async (isSaveAsDraft = false) => {
        ...
        try {
            ...
            if (isSaveAsDraft) {
                ...
                navigate("/programs/decisiontreeflow", { state: { programDetails: dataToSend } });
            }
        } catch (err) {
                                    ...
                                    <button
                                        ...
                                        onClick={() => {
                                            if (item.href === "/decisiontreeflow") {
                                                ...
                                                if(!formData.name || !formData.condition_type || !formData.estimate_duration || !formData.therapy_goal || !formData.target_group || !formData.program_description){
                                        ...
                                        <div className="flex flex-col">
                                            ...
                                            <CustomDropdown
                                                ...
                                                onSelect={(item) => {
                                                    ...
                                                    setFormData((prev) => ({ ...prev, condition_type: item.name }))
                                                }}
                                            />
                                        </div>
